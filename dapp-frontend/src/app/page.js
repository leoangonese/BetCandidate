...
export default function Home() {
  ...
  function btnLoginClick() {
    setMessage("Conectando conta MetaMask");
    doLogin().then(account => push("/bet")).catch(e => setMessage(e.message));
  }
          ...
          <div className="col-6">
            ...
            <div className="d-flex justify-content-start">
              <button type="button" className="btn btn-primary btn-lg px-4" onClick={btnLoginClick}>
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/36/MetaMask_Fox.svg/640px-MetaMask_Fox.svg.png" width={64} className="me-3" />
                Conectar MetaMask
              </button>
            </div>
